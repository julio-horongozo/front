...
import condutivimetro from '../Home/condutivimetro.png';
...
function Condutivimetro() {
  ...
  return (
    <><Container>
      <Row>
        <Col xs={12} md={6}>
          <Image src={condutivimetro} rounded style={{ width: '100%' }} />
        </Col>
