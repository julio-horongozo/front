...
export default function Rodape() {
  return (
    <MDBFooter bgColor='light' className='text-center text-lg-start text-muted'>
      <section className='d-flex justify-content-center justify-content-lg-between p-4 border-bottom' style={{backgroundColor: '#3c4c63', color: '#fff'}}>
        <div className='me-5 d-none d-lg-block'>
          <span>Nos Encontre Nas Redes Sociais</span>
        </div>

        <div>
          <a href='https://www.facebook.com/julio.horongozo' className='me-4 text-reset' target='_blank'>
          ...
          <a href='https://twitter.com/horongozo_julio' className='me-4 text-reset' target='_blank'>
          <i><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
          ...
          <a href='https://www.instagram.com/julio_horongozo/' className='me-4 text-reset' target='_blank'>
          <i><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
          ...
          <a href='https://www.threads.net/@julio_horongozo' className='me-4 text-reset' target='_blank'>
          <i><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
          ...
          <a href='https://github.com/julio-horongozo/' className='me-4 text-reset' target='_blank'>
          <i><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
        ...
        <MDBContainer className='text-center text-md-start mt-5'>
          <MDBRow className='mt-3'>
            ...
            <MDBCol md="2" lg="2" xl="2" className='mx-auto mb-4'>
              <h6 className='text-uppercase fw-bold mb-4'>CONTATO
</h6>
              <p>
              ...
              <p>
                <a href='#!' className='text-reset' style={{textDecoration: 'none'}}>
                  Tel:+55(42)9 9118-6219
                </a>
              </p>
            </MDBCol>

            <MDBCol md="3" lg="2" xl="2" className='mx-auto mb-4'>
              <h6 className='text-uppercase fw-bold mb-4'>ENDEREÇO</h6>
              <p>
                Rua Alzira De Abreu, 1040
              </p>
              <p>
                Centro - Cantagalo-PR
              </p>
              <p>
                <a href='https://www.google.com.br/maps/search/-25.376909,+-52.124415?entry=tts' className='text-reset' target='_blank' style={{textDecoration: 'none'}}>
                  Ver Mapa
                </a>
              </p>
            </MDBCol>
            ...
            <MDBCol md="4" lg="3" xl="3" className='mx-auto mb-md-0 mb-4'>
              ...
              <p>
              <a href='/segurancaeprivacidade' className='text-reset' style={{textDecoration: 'none'}}>
