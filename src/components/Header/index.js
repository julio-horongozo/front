      ...
      <Container fluid>
        ...
        <Navbar.Collapse id="navbarScroll">
          <Nav
            ...
            navbarScroll
          >
            <Button href="/" id='botaoPerfil' style={{color: '#3c4c63'}}>Home</Button>
            <Button href="/sobre" id='botaoPerfil' style={{color: '#3c4c63'}}>Sobre</Button>
            <Button href="/produtos"id='botaoPerfil' style={{color: '#3c4c63'}}>Produtos</Button>
            ...
            <Button href="/admin" id='admin' style={{color: '#3c4c63'}}>Painel Admin</Button>
            

          </Nav>
          
          <Button onClick={verificarLoginCarrinho} style={{margin: '20px'}} id='botaoPerfil'>
